...
|---|---|---|
| `layout` | `one`, `two` | `two` puts model, folder, branch, pr and badges on the first line and context, limits, cost and lines on the second. |
...
`statusline.json`, then new segments (cache warmth, session clock), presets and
