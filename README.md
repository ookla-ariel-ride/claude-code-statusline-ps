...
(#89), a diagnostics log that can outgrow its cap while another render holds the lock (#93), test
families that fail under parallel load (#94, #99, #102), and a clock seam so the screenshots
regenerate to the same bytes (#98). The
