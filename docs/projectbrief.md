...
3. Style and terminal: an ASCII style and a light palette (#27, #28). The right-aligned group and its
   wall clock (#25) are done, and are the first thing on the line whose position is decided by the
   width rather than by the order. Taskbar progress (#24) is done and is the first writer of terminal
