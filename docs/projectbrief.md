...
1. New segments: cache warmth and hit ratio, links on the folder and branch, session clock
   (#2, #3, #8, #13). Cost per turn (#5) is done and is the first reader of the state file, and the
